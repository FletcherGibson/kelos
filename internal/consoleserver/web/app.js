...
`;
    ...
    function reconcileMarkdownChildren(parent, rendered) {
        ...
        renderedChildren.forEach((next, index) => {
            ...
            if (!current) {
                ...
                if (current.classList.contains('code-copy-button'))
                    return;
        ...
        for (const current of currentChildren.slice(renderedChildren.length))
    ...
    const pendingAssistantRenders = new WeakMap();
    ...
    function finishAssistantMarkdown(bubble, text) {
